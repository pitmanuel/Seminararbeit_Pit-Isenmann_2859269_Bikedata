...
for station in stations:
    ...
    #median_wert = df["Wert"].median()
    #df["Wert"] = df["Wert"].fillna(median_wert)   # NaN testweise durch Median ersetzen
    ...
    def objective(trial):
        ...
        return r2_score(y_test, y_pred)  # Maximierung des R²

    study = optuna.create_study(direction="maximize")
    study.optimize(objective, n_trials=50)  # 50 Versuche, kann erhöht werden
    ...
    print("R² auf Testdaten:", best_rf.score(X_test, y_test))
